...
[ADR-002](docs/adr/ADR-002-state-and-persistence.md). План работ: [TASKS.md](TASKS.md).
...
| Фаза | Цель | Снимает |
|---|---|---|
| 0. Демо-минимум | продукт можно показать постороннему | 10 блокеров демонстрации |
| 1. Контракты и модель | одна модель данных, порты, линт-правило | D1, D2 |
...
| Нет тестов | 53 человеко-дня правок без сетки безопасности | фаза 5 частично поднимается вперёд: тесты на расчёты закупки пишем в фазе 3, вместе с переносом |
