...
export const sources: Source[] = [
  ...
  { id: "src-tg-gareev-0904", kind: "telegram", title: "Текстовый отчёт прораба с фото", author: "Гареев Р. М.", receivedAt: "2026-09-04T17:10:00", projectId: "p-korona", location: "сообщение 1", excerpt: "Захватка 3, К–Р, 12–14 эт. Подконструкция 160 кв, утеплитель два слоя, мембрана. Кронштейны лежат на улице, нужен навес." },
  { id: "src-tg-nazarov-0903", kind: "telegram", title: "Фото без подписи", author: "Назаров Т. Б.", receivedAt: "2026-09-03T16:45:00", projectId: "p-korona", location: "2 фото", excerpt: "Фотографии разметки анкеров на стилобате и партии керамогранита на приёмке. Текста нет." },
  { id: "src-tg-gareev-0902", kind: "telegram", title: "Голосовое сообщение прораба, 32 с", author: "Гареев Р. М.", receivedAt: "2026-09-02T18:12:00", projectId: "p-korona", location: "00:00–00:32", excerpt: "Вторая захватка, девятый этаж, облицовка сто семьдесят шесть квадратов, откосы четырнадцать. Было пятеро." },
  { id: "src-tg-gareev-0901", kind: "telegram", title: "Текстовый отчёт прораба", author: "Гареев Р. М.", receivedAt: "2026-09-01T17:35:00", projectId: "p-korona", location: "сообщение 1", excerpt: "Захв. 3, 12-13 эт. Кронштейны 420 шт, подконструкция 140 кв. Шестеро." },
  { id: "src-mail-fk-323", kind: "email", title: "Коммерческое предложение «Фасад-Комплект» по керамограниту", author: "sales@fasad-komplekt.ru", receivedAt: "2026-09-05T09:40:00", projectId: "p-korona", location: "таблица 1, строка 1", excerpt: "Керамогранит 600×600×10, антрацит матовый — 1 685 руб./м² без НДС. Доставка на объект 35 000 руб. Отгрузка через 16 рабочих дней." },
  { id: "src-mail-kt-323", kind: "email", title: "Коммерческое предложение «Керамика Трейд» по керамограниту", author: "info@keramika-trade.ru", receivedAt: "2026-09-04T12:10:00", projectId: "p-korona", location: "вложение КП.pdf, стр. 1", excerpt: "Керамогранит 600×600, толщина 9 мм, антрацит — 1 710 руб./м² без НДС. Доставка 42 000 руб. Срок 24 рабочих дня." },
  { id: "src-mail-sk-324", kind: "email", title: "Счёт и КП «СтройКрепёж» по утеплителю", author: "opt@stroykrepezh.ru", receivedAt: "2026-08-21T15:30:00", projectId: "p-korona", location: "счёт № 1184, строки 1–2", excerpt: "Плита из каменной ваты 100 мм — 412 руб./м², мембрана ветрозащитная — 96 руб./м², без НДС. Доставка 12 000 руб. Отгрузка 7 дней." },
...
export const evidence: Evidence[] = [
  ...
  { id: "ev-6", reportId: "fr-korona-0904", kind: "photo", caption: "Захватка 3, оси К–Р, подконструкция 12 этаж", takenAt: "2026-09-04T17:05:00", location: "фото 1" },
  { id: "ev-7", reportId: "fr-korona-0904", kind: "photo", caption: "Утеплитель в два слоя, 13 этаж", takenAt: "2026-09-04T17:06:00", location: "фото 2" },
  { id: "ev-8", reportId: "fr-korona-0904", kind: "photo", caption: "Мембрана, нахлёст 100 мм", takenAt: "2026-09-04T17:07:00", location: "фото 3" },
  { id: "ev-9", reportId: "fr-korona-0904", kind: "photo", caption: "Складирование кронштейнов на отметке 0.000", takenAt: "2026-09-04T17:09:00", location: "фото 4" },
  { id: "ev-10", reportId: "fr-korona-0903", kind: "photo", caption: "Стилобат, оси А–Г, разметка анкеров", takenAt: "2026-09-03T16:40:00", location: "фото 1" },
  { id: "ev-11", reportId: "fr-korona-0903", kind: "photo", caption: "Партия керамогранита на приёмке", takenAt: "2026-09-03T16:42:00", location: "фото 2" },
  { id: "ev-12", reportId: "fr-korona-0902", kind: "audio", caption: "Голосовой отчёт, 32 с", takenAt: "2026-09-02T18:12:00", location: "00:00–00:32" },
  { id: "ev-13", reportId: "fr-korona-0902", kind: "photo", caption: "Захватка 2, облицовка 9 этаж", takenAt: "2026-09-02T18:08:00", location: "фото 1" },
  { id: "ev-14", reportId: "fr-korona-0902", kind: "photo", caption: "Откосы окон, подрезка плитки", takenAt: "2026-09-02T18:09:00", location: "фото 2" },
  { id: "ev-15", reportId: "fr-korona-0901", kind: "photo", caption: "Захватка 3, монтаж кронштейнов", takenAt: "2026-09-01T17:30:00", location: "фото 1" },
];
...
export const fieldReports: FieldReport[] = [
  {
    ...
    issues: [
      { id: "is-1", text: "Не хватает нащельника углового — 12 шт, узлы на 10 этаже не закрыты", severity: "blocker" },
      { id: "is-2", text: "Состав бригады не указан явно: «работали вчетвером»", severity: "warning" },
    ],
    declaredQty: 184,
    unit: "м²",
    acceptedQty: null,
  ...
  },
  {
    ...
    status: "review",
    summary: "Захватка 3, оси К–Р, этажи 12–14: смонтировано 160 м² подконструкции, уложен утеплитель в два слоя и мембрана.",
    issues: [{ id: "is-3", text: "Кронштейны хранятся на улице без укрытия — нужен навес", severity: "warning" }],
    declaredQty: 160,
    unit: "м²",
    acceptedQty: null,
    headcount: 6,
    evidenceIds: ["ev-6", "ev-7", "ev-8", "ev-9"],
  ...
  },
  {
    ...
    issues: [
      { id: "is-4", text: "Объём не указан — по фото нельзя принять работы", severity: "blocker" },
      { id: "is-5", text: "На партии керамогранита нет паспорта качества", severity: "warning" },
    ],
    declaredQty: 0,
    unit: "м²",
    acceptedQty: null,
  ...
  },
  {
    ...
    issues: [{ id: "is-6", text: "Сколы на партии керамогранита 420 м²", severity: "blocker" }],
    declaredQty: 220,
    unit: "м²",
    acceptedQty: 205,
    headcount: 7,
...
export const extractions: Extraction[] = [
  ...
  { id: "ex-13", sourceId: "src-tg-gareev-0902", eventId: null, label: "Захватка", value: "Захватка 2, 9 этаж", confidence: 0.95, quote: "вторая захватка, девятый этаж", location: "00:02", appliedTo: { entity: "FieldReport", id: "fr-korona-0902" } },
  { id: "ex-14", sourceId: "src-tg-gareev-0902", eventId: null, label: "Вид работ", value: "Монтаж облицовки", confidence: 0.93, quote: "облицовка", location: "00:07", appliedTo: { entity: "FieldReport", id: "fr-korona-0902" } },
  { id: "ex-15", sourceId: "src-tg-gareev-0902", eventId: null, label: "Объём облицовки", value: "176 м²", confidence: 0.91, quote: "сто семьдесят шесть квадратов", location: "00:10", appliedTo: { entity: "FieldReport", id: "fr-korona-0902" } },
  { id: "ex-16", sourceId: "src-tg-gareev-0902", eventId: null, label: "Объём откосов", value: "14 м²", confidence: 0.84, quote: "откосы четырнадцать", location: "00:18", appliedTo: { entity: "FieldReport", id: "fr-korona-0902" } },
  { id: "ex-17", sourceId: "src-tg-gareev-0902", eventId: null, label: "Состав бригады", value: "5 человек", confidence: 0.88, quote: "было пятеро", location: "00:26", appliedTo: { entity: "FieldReport", id: "fr-korona-0902" } },
