...
export const sources: Source[] = [
  ...
  { id: "src-call-dsk", kind: "call", title: "Звонок заказчика ГК «Стройинвест»", author: "Лебедева О. К.", receivedAt: "2026-09-04T11:30:00", projectId: "p-korona", location: "04:12", excerpt: "Просим подтвердить готовность этапа 1 к 10 сентября." },
  { id: "src-pd-korona-ar", kind: "upload", title: "Проектная документация, раздел АР, лист 14", author: "Волкова М. С.", receivedAt: "2026-08-27T10:05:00", projectId: "p-korona", location: "стр. 14, таблица 4", excerpt: "Кронштейн КР-150 оцинкованный — 12 400 шт. Направляющая Т-образная 60×40 — 8 600 пог. м. Керамогранит 600×600, антрацит — 9 800 м²." },
  { id: "src-pd-korona-spec", kind: "upload", title: "Спецификация материалов НВФ, лист 21", author: "Волкова М. С.", receivedAt: "2026-08-27T10:05:00", projectId: "p-korona", location: "стр. 21, таблица 7", excerpt: "Минеральная вата 100 мм — 11 200 м². Анкер клиновой 10×100 — 24 000 шт. Нащельник угловой — 480 шт. Противопожарная отсечка — 1 800 пог. м." },
  { id: "src-pd-korona-uzly", kind: "upload", title: "Узлы примыканий, лист 33", author: "Волкова М. С.", receivedAt: "2026-08-27T10:05:00", projectId: "p-korona", location: "стр. 33, узел 6", excerpt: "Парапетная крышка по контуру кровли, заклёпка вытяжная 4×12 по узлу 6. Количество уточняется по месту." },
  { id: "src-pd-meridian-spec", kind: "upload", title: "Спецификация НВФ, рев. 2, лист 18", author: "Волкова М. С.", receivedAt: "2026-07-22T11:00:00", projectId: "p-meridian", location: "стр. 18, таблица 5", excerpt: "Керамогранит 600×1200, серый — 7 900 м². Кронштейн КР-120 — 9 600 шт. Направляющая Г-образная 40×40 — 6 100 пог. м." },
  { id: "src-pd-primorsky-spec", kind: "upload", title: "Спецификация НВФ, рев. 1, лист 26", author: "Волкова М. С.", receivedAt: "2026-06-02T15:30:00", projectId: "p-primorsky", location: "стр. 26, таблица 9", excerpt: "Фиброцементная панель 1200×3000 — 10 400 м². Минеральная вата 150 мм — 11 000 м². Ветрозащитная мембрана — ориентировочно 11 500 м²." },
  { id: "src-pd-school-spec", kind: "upload", title: "Ведомость материалов, рев. 2, лист 7", author: "Волкова М. С.", receivedAt: "2026-05-19T10:10:00", projectId: "p-school", location: "стр. 7", excerpt: "Штукатурная смесь фасадная — 38 т. Сетка стеклотканевая — 5 600 м². Грунт глубокого проникновения — 1 250 л." },
  { id: "src-pd-galaxy-spec", kind: "upload", title: "Спецификация витражей, рев. 1, лист 12", author: "Волкова М. С.", receivedAt: "2026-06-24T14:45:00", projectId: "p-galaxy", location: "стр. 12, таблица 3", excerpt: "Стеклопакет 2-камерный 1500×3200 — 312 шт. Стойка алюминиевая 150 мм — 1 480 пог. м. Уплотнитель EPDM — по месту." },
  { id: "src-mail-mp", kind: "email", title: "Коммерческое предложение «МеталлПрофиль Групп»", author: "zakaz@mp-group.ru", receivedAt: "2026-09-04T16:40:00", projectId: "p-korona", location: "абзац 1", excerpt: "Кронштейн КР-150 — 281 руб./шт, направляющая Т-образная — 399 руб./пог. м. Отгрузка через 18 рабочих дней." },
  { id: "src-mail-kt", kind: "email", title: "Коммерческое предложение «Керамика Трейд»", author: "info@keramika-trade.ru", receivedAt: "2026-09-04T10:22:00", projectId: "p-meridian", location: "абзац 2", excerpt: "Керамогранит 600×600, антрацит — 1 740 руб./м². Срок поставки 24 рабочих дня со дня оплаты." },
];
