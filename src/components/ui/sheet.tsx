...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-surface p-6 shadow-[var(--lift-3)] transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-200 data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=open]:fade-in-0 data-[state=closed]:fade-out-0",
  {
    variants: {
      side: {
