...
export const Route = createFileRoute("/tasks")({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Происхождение задачи важно так же, как сама задача." },
...
function TasksPage() {
  return (
    <PagePlaceholder
      ...
      planned={["Таблица и канбан по статусам","Происхождение: отчёт, договор, агент, вручную","Просрочки, ответственные, сроки","Переход к первоисточнику задачи"]}
    />
  );
}
