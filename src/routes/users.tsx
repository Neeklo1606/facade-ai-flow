              ...
              <table className="w-full min-w-[860px] border-collapse text-table">
                <thead>
                  <tr className="border-b border-border-strong">
                    <th className="sticky left-0 z-10 bg-elevated px-4 py-2.5 text-left text-caption font-medium text-text-secondary">
                      Раздел
                    </th>
                ...
                <tbody>
                  {permissionMatrix.map((row, i) => (
                    <tr key={row.section} className={cn("border-b border-border", i % 2 === 1 && "bg-subtle/60")}>
                      <td className={cn("sticky left-0 z-10 px-4 py-2.5", i % 2 === 1 ? "bg-subtle" : "bg-elevated")}>
